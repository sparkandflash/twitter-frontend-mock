  ...
  return (
    <Flex flexDirection="column" flex="auto">
      <Box p="10px" h="50px" minW={"100%"}>
        <Text fontSize="lg" className="menu-home" as="b">
          Home
        </Text>
      </Box>
      ...
      <Box className="home-tweet-box" borderBottomWidth="1px">
        <Box display="flex">
          ...
          <Textarea
            ...
            fontSize={19}
            variant="unstyled"
            className="place-holder-textarea"
            placeholder="What's happening ?"
          />
        </Box>
        <Box display="flex">
          <Button></Button> <Spacer />{" "}
          <Button disabled={true} borderRadius={50} colorScheme={"twitter"}>
            Tweet
          </Button>
        </Box>
      </Box>
